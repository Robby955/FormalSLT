...
[![theorems and lemmas](https://img.shields.io/badge/theorems%2Flemmas-4%2C101-brightgreen.svg)](#checked-surfaces)
[![FormalSLT modules](https://img.shields.io/badge/FormalSLT%20modules-271-blue.svg)](#module-map)
[![Lean lines](https://img.shields.io/badge/Lean%20lines-147%2C793-brightgreen.svg)](#audit-commands)
...
bounded fixed scores, overlap and ratio certificates, and candidate
target-kernel contraction; its true-invariant, trace-alignment, and final
numerical certificates remain open. Application-specific declarations are not
part of the 19-name v0.2 compatibility promise.
