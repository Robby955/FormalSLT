...
posterior-dependent square-root-plus-linear wrapper.
...
| PAC-Bayes Bernstein margin-proxy shell | `finitePACBayesBernsteinMargin_badEventMass_le_delta` | `examples/CheckPACBayesBernstein.lean` |
