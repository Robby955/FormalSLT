...
[![theorems checked](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/Robby955/FormalSLT/main/docs/badges/theorems.json)](#checked-surfaces)
[![Lean modules](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/Robby955/FormalSLT/main/docs/badges/modules.json)](#module-map)
...
```mermaid
flowchart LR
    A["<b>FormalSLT</b><br/>Lean 4 library<br/>finite SLT theorems<br/>0 sorry · 0 admit"]
    B["<b>theorempath.com</b><br/>theorem pages<br/>source links + audit pages"]
    C["<b>TheoremPath iOS</b><br/>review paths<br/>same theorem IDs"]
    A -- "checked statements" --> B
    A -- "checked statements" --> C
```

Live counts (theorems, modules, lines) are surfaced by the badges above and
regenerated by [`scripts/generate_badge_counts.py`](./scripts/generate_badge_counts.py)
on every CI run.
