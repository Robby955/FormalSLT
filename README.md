...
**61 Lean modules. 32,217 lines of Lean. Zero `sorry`. Zero `admit`. Zero custom axioms.**
<!-- STATS:END -->
...
- PAC-Bayes includes a finite `[0,1]` bounded-loss Catoni-style confidence
  ...
  derived from the iid finite product law. Finite-grid Bernstein optimization,
  exact all-real-`λ`, infinite-hypothesis, and continuous-posterior variants
  remain future work.
...
- [ ] PAC-Bayes Bernstein finite-grid/all-real-`λ` or continuous-posterior
  extensions
