...
|---|---|---|
| [Lean-MoDS/StatsMLlib at `37286c3d`](https://github.com/Lean-MoDS/StatsMLlib/tree/37286c3d2c7e17642fbe26988be40f3ff982f944) | Subject-organized probability, statistics, and machine-learning library consolidating Gaussian concentration, empirical-process, Rademacher/Dudley, localized least-squares, and random-matrix developments associated with the Zhang--Lee--Liu and Sonoda lines of work; its checked source includes `massart_lemma_pmf`. | Broader foundational and continuous empirical-process coverage and direct Massart prior art. The bounded audit did not identify FormalSLT's combined effective-loss-image Massart endpoint at this pin. |
| [YuanheZ/lean-stat-learning-theory at `d0f506f`](https://github.com/YuanheZ/lean-stat-learning-theory/tree/d0f506f0a695018265dccb33bcb05e2f5ca1c876) / [arXiv:2602.02285](https://arxiv.org/abs/2602.02285) | Empirical-process formalization: Gaussian Lipschitz concentration, Dudley's entropy integral for sub-Gaussian processes, localized Gaussian complexity, critical radii, and least-squares rates. | Strong adjacent prior art for localized SLT formalization. FormalSLT's finite Bernstein/localization route is a different bounded-excess-loss path. This row records the exact source head inspected on August 22, 2026; it is not an exhaustive endpoint comparison. |
| [auto-res/lean-rademacher at `bc333764`](https://github.com/auto-res/lean-rademacher/tree/bc333764168dab8ac58afcec4b9df8cacf9b54ad) / [arXiv:2503.19605](https://arxiv.org/abs/2503.19605) | Rademacher-complexity generalization bounds, symmetrization, McDiarmid/Hoeffding-style concentration, and Dudley/Rademacher infrastructure, including [`massart_lemma_pmf`](https://github.com/auto-res/lean-rademacher/blob/bc333764168dab8ac58afcec4b9df8cacf9b54ad/FoML/Entropy/Massart.lean#L150-L293), [`empiricalRademacherComplexity_without_abs_reindex_eq_of_surjective`](https://github.com/auto-res/lean-rademacher/blob/bc333764168dab8ac58afcec4b9df8cacf9b54ad/FoML/Rademacher/Reindex.lean#L78-L86), [`IsERM.excessRisk_le_two_mul_uniformDeviation`](https://github.com/auto-res/lean-rademacher/blob/bc333764168dab8ac58afcec4b9df8cacf9b54ad/FoML/Learning/ERM.lean#L102-L115), and [`erm_excessRisk_tail_bound_separable_of_rademacher_le`](https://github.com/auto-res/lean-rademacher/blob/bc333764168dab8ac58afcec4b9df8cacf9b54ad/FoML/Generalization/Learning.lean#L208-L230). | Direct theorem-level prior art for Massart and ERM excess-risk, plus adjacent one-sided reindexing infrastructure. The inspected declarations do not combine effective loss-image cardinality with Massart in one endpoint and do not have FormalSLT's exact finite ERM signature, two supplied effective-growth premises, constants, or factor-two tail. |
...
| [StatLean VC/Rademacher at `e1ef06b`](https://github.com/StatLean/Stat-Lean/tree/e1ef06bf52d2a8896439c5b59d982d9aad28a254) | Direct checked declarations include [`growthFunction_le_sum_choose`](https://github.com/StatLean/Stat-Lean/blob/e1ef06bf52d2a8896439c5b59d982d9aad28a254/StatLean/ConcentrationInequalities/VC/SauerShelah.lean#L154-L161), [`massart`](https://github.com/StatLean/Stat-Lean/blob/e1ef06bf52d2a8896439c5b59d982d9aad28a254/StatLean/StatisticalLearning/Rademacher/Structural.lean#L483-L498), [`rademacher_erm_excess`](https://github.com/StatLean/Stat-Lean/blob/e1ef06bf52d2a8896439c5b59d982d9aad28a254/StatLean/StatisticalLearning/Rademacher/Generalization.lean#L721-L739), and [`vc_generalization`](https://github.com/StatLean/Stat-Lean/blob/e1ef06bf52d2a8896439c5b59d982d9aad28a254/StatLean/ConcentrationInequalities/VC/Generalization.lean#L262-L309). | Direct formalization prior art for Sauer--Shelah, Massart, ERM excess-risk, and VC generalization. FormalSLT's row 18 additionally factors through the effective loss image; row 19 assumes two supplied effective-growth bounds and has different constants and tail organization. |
...
| [AFP: Sauer--Shelah Lemma](https://www.isa-afp.org/entries/Sauer_Shelah_Lemma.html) | The official `afp-2026-08-12` artifact contains `sauer_shelah_0`, `sauer_shelah`, and `sauer_shelah_alt`; the last formulation uses the actual finite union of the set family as its universe. | Direct independent Isabelle/HOL prior formalization for FormalSLT row 17. FormalSLT's public wrapper instead uses the ambient finite type and follows Mathlib's Pajor-plus-Sauer proof path. |
