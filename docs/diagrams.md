...
flowchart TD
    ...
    variance["Exact indicator variance<br/>Rᵢ(1-Rᵢ)/n"]
    moment["Prior-averaged indicator<br/>Bernstein moment"]
    confidence["Fixed-tilt all-posterior<br/>confidence event"]
