...
FRONTIER_LANES: list[dict[str, str]] = [
    {
        ...
        "next_step": (
            ...
            "weight or target-policy value theorem. Add automatic mixture or "
            "coin-betting competition and a computable certificate layer for "
            "the measurable growing-prefix oracle. Extend the already checked "
    ...
    },
    {
        ...
        "next_step": (
            ...
            "measurable hypothesis spaces. Build a computable mixture or "
            "coin-betting construction that competes "
        ...
        "boundary": (
            ...
            "These results do not provide a countably supported "
            "strategy posterior, a computable evaluator, or automatic "
            "competition with all legal strategies. The hybrid expression is "
    ...
    },
    {
        ...
        "scope": (
            ...
            "joint score contract, plus a finite-state full-prefix trajectory "
        ...
        "next_step": (
            "Extend the finite joint model--strategy posterior theorem to "
            "measurable hypothesis spaces. Add computable automatic "
            "competition over legal "
