...
| `PACBayes` | Change of measure, KL calculations, bounded-loss and Bernstein bounds, process-level time-uniform results for fixed prior/posterior pairs on arbitrary measurable hypothesis spaces, and finite-class or finite-dimensional spherical-Gaussian i.i.d. results at discrete sample times, including finite data-dependent posterior/tilt selection. |
