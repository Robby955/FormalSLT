...
The empirical Rademacher complexity depends on the *distinct loss vectors*
...
This is the key reduction: the signed-average sup depends on i through
...
Claim-facing wrapper for theorempath.com evidence entry `claim:rademacher-complexity::massart-finite-class-bound`.
-/
