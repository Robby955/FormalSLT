...
The conclusion controls a tilt-weighted conditional-risk minus observed-score
sum.  It is not an unweighted average-risk bound and does not construct an
e-process from a post-hoc selected tilt schedule.
-/
