...
/-!
# PAC-Bayes generalization certificate - compiler output `Cert_C`

This file was generated by `compiler/compile.py` from
`compiler/specs/Cert_C.json`. It is a machine-checkable finite
PAC-Bayes bounded-loss certificate.

## Instance statistics
* hypothesis class: `Fin 128`
* data domain: `Fin 2`
* sample size: `n = 10000`
* bounded loss width: `B = 1`
* prior: uniform
* posterior summary: softmax
* posterior KL recorded by the sweep: `4.5`
* confidence delta: `0.05`
* complexity budget used in Lean: `7.49573227355`
* computed McAllester bound: `0.0193594063359`
...
namespace FormalSLT.PACBayes.Generated.Cert_C
...
theorem prior_isFullSupportPMF : IsFullSupportPMF prior := by
  ...
  · show (∑ i : Fin 128, prior i) = 1
    simp [prior]
  · intro _; norm_num [prior]

/-- Every generated loss entry lies in `[0, 1]`. -/
theorem loss_mem_unitInterval :
    ∀ i : Fin 128, ∀ z : Fin 2, 0 ≤ loss i z ∧ loss i z ≤ 1 := by
  intro i z
  fin_cases z <;> norm_num [loss, Fin.ext_iff]

/-- Machine-checked PAC-Bayes certificate for `Cert_C`. -/
theorem cert_C_generalization_certificate :
...
end FormalSLT.PACBayes.Generated.Cert_C
