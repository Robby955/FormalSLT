...
metric-entropy integral with the symmetrization factor included. The boundedness
and measurability assumptions also discharge integrability of the empirical
Rademacher complexity internally. -/
